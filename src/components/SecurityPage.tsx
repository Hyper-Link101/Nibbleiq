        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-700 mt-4">
              For a complete list of subprocessors, please contact us at <a href="mailto:security@nibbleiq.com" className="text-orange-600 hover:text-orange-700">security@nibbleiq.com</a>.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <p className="text-slate-700 mb-2"><strong>Security Team:</strong> <a href="mailto:security@nibbleiq.com" className="text-orange-600 hover:text-orange-700">security@nibbleiq.com</a></p>
              <p className="text-slate-700 mb-2"><strong>Privacy Inquiries:</strong> <a href="mailto:privacy@nibbleiq.com" className="text-orange-600 hover:text-orange-700">privacy@nibbleiq.com</a></p>
              <p className="text-slate-700 mb-4"><strong>General Contact:</strong> <a href="mailto:hello@nibbleiq.com" className="text-orange-600 hover:text-orange-700">hello@nibbleiq.com</a></p>
              <p className="text-slate-700 text-sm mt-4">
                For security vulnerability reports, please use our responsible disclosure process at <a href="mailto:security@nibbleiq.com" className="text-orange-600 hover:text-orange-700">security@nibbleiq.com</a>. We appreciate the security community's efforts to keep our platform safe.
              </p>
            </div>
          </section>
        </div>
