  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-amber-50 via-orange-50 to-red-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-10">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1762806883627-4bcbfad98a2c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3YXJtJTIwcmVzdGF1cmFudCUyMGFtYmlhbmNlfGVufDF8fHx8MTc2NDczNzI3N3ww&ixlib=rb-4.1.0&q=80&w=1200&utm_source=figma&utm_medium=referral"
