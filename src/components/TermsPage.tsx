      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-700">
              We provide customer support via email at <a href="mailto:hello@nibbleiq.com" className="text-orange-600 hover:text-orange-700">hello@nibbleiq.com</a>. Support hours and response times depend on your subscription plan.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <p className="text-slate-700 mb-2"><strong>Email:</strong> <a href="mailto:legal@nibbleiq.com" className="text-orange-600 hover:text-orange-700">legal@nibbleiq.com</a></p>
              <p className="text-slate-700 mb-2"><strong>General Contact:</strong> <a href="mailto:hello@nibbleiq.com" className="text-orange-600 hover:text-orange-700">hello@nibbleiq.com</a></p>
