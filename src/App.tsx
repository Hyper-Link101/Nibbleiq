...
export default function App() {
  ...
  return (
    <HelmetProvider>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-6 focus:py-3 focus:bg-white focus:text-slate-900 focus:shadow-xl focus:rounded-lg focus:font-bold focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all">Skip to main content</a>
